...
print('''
Timestamps may look the same, but they are only coming through as ints.
You can check by using the sleep() statements commented in the code.
I figured in the real world if someone is switching through programs,
it will likely be more than one second in time, also to accommodate for
this, my code checks for the first pid that is oldest and sticks with it 
until it finds one that is less.
''')
